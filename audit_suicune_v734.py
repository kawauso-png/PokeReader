...
need('pub fn evaluate_empirical_branch_pre(' in p,'branch-resolved PRE evaluator missing')
need('emp_pre_post(proto,rot,post_proto,post_rot)?' in p,'PRE evaluator is not post-conditioned')
...
print('v7.3.4 audit PASS: shiny-only A/r10 bucket76 -> C/r8 PRE probe, SLOT1, bucket-locked two-stage arm')
