...
pub mod test_stubs {
    ...
    #[no_mangle]
    pub extern "C" fn host_system_tick() -> u64 {
        0
    }
    #[no_mangle]
    ...
    #[no_mangle]
    pub extern "C" fn host_trace_file_open(_index: u32) -> u32 {
        0
    }
    #[no_mangle]
    pub extern "C" fn host_trace_file_write(_data: *const u8, _len: u32) -> u32 {
        0
    }
    #[no_mangle]
