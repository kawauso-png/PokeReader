...
typedef struct {uint32_t error,arm_pc,arm_op,guest_pc,frame,normal,final,reads,lcd,lcdlong,timer;uint64_t instructions;uint16_t dv;uint8_t shiny;} Shadow7113Result;
