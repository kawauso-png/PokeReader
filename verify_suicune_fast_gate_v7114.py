...
s=(r/'v7113/gate_runtime.c').read_text();assert 'if(seconds>900)' in s and ('GATE7114_BENCH' in s or 'GATE7115_BENCH' in s) and ('GATE7114_CPU' in s or 'GATE7115_CPU' in s)
